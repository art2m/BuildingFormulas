...
namespace MusicManager
{
	public partial class dlgTagData
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MusicManager.dlgSongTag
			this.WidthRequest = 1020;
			this.HeightRequest = 768;
			this.Name = "MusicManager.clsSongTagData";
			this.Title = global::Mono.Unix.Catalog.GetString ("Song Tag Data");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child MusicManager.clsSongTagData.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child MusicManager.clsSongTagData.ActionArea
