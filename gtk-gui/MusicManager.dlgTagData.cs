...
{
	public partial class dlgTagData
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget MusicManager.dlgTagData
			this.WidthRequest = 1020;
			this.HeightRequest = 768;
			this.Name = "MusicManager.dlgTagData";
			this.Title = global::Mono.Unix.Catalog.GetString ("Song Tag Information");
			this.WindowPosition = ((global::Gtk.WindowPosition)(1));
			this.BorderWidth = ((uint)(4));
			// Internal child MusicManager.dlgTagData.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child MusicManager.dlgTagData.ActionArea
