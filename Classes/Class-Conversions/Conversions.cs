...
namespace BuildingFormulas
{
	...
	public class Conversions
	{
		...
		public double ConvertCubicInchesToCubicCentimeters(double inchesCubic)
		{
			...
			retVal = inchesCubic *
			this.math.ConvertCubicInchesToCubicCentimeters;
		...
		public double ConvertCubicInchesToCubicMillimeters(double inchesCubic)
		{
			...
			retVal = inchesCubic *
			this.math.ConvertCubicInchesToCubicMillimeters;
			...
			double centimetersCubic)
		{
			...
			retVal = centimetersCubic *
			this.math.ConvertCubicYardsToCubicCentimeters;
			...
			double millimetersCubic)
		{
			...
			retVal = millimetersCubic *
			this.math.ConvertCubicYardsToCubicMillimeters;
			...
			double centimetersCubic)
		{
			...
			retVal = centimetersCubic *
			this.math.ConvertCubicFeetToCubicCentimeters;
			...
			double millimetersCubic)
		{
			...
			retVal = millimetersCubic *
			this.math.ConvertCubicFeetToCubicMeters;
		...
		public double ConvertCubicMetersToCubicCentimeters(double metersCubic)
		{
			...
			retVal = metersCubic *
			this.math.ConvertCubicMetersToCubicCentimeters;
		...
		public double ConvertCubicMetersToCubicMillimeters(double metersCubic)
		{
			...
			retVal = metersCubic *
			this.math.ConvertCubicMeterToCubicCentimeters;
			...
			double centimetersCubic)
		{
			...
			retVal = centimetersCubic *
			this.math.ConvertCubicCentimetersToCubicMeters;
			...
			double centimetersCubic)
		{
			...
			retVal = centimetersCubic *
			this.math.CubicCubicCentimeterToCubicMillimeters;
			...
			double millimetersCubic)
		{
			...
			retVal = millimetersCubic *
			this.math.ConvertCubicMillimetersToCubicMeters;
			...
			double millimetersCubic)
		{
			...
			retVal = millimetersCubic *
			this.math.ConvertCubicCMillimetersToCubicCentimeters;
