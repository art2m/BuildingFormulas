...
/// <summary>
/// Class -- public static class Artist_Dictionary
/// 
/// Contains a collection of artist and albums. Key is the artist name.
/// value is the album names in an array of strings.
/// </summary>
using System;
...
{
	public static class Artist_Dictionary
	{
		static Dictionary <string, string[]>  dicArtist = 
                                    new Dictionary<string, string[]> ();
		private static string className = "Artist_Dictionary";
