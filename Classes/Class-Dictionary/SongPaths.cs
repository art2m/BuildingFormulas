...
/// Class -- SongPaths.cs
/// 
/// Store Album Name as Key. Song Path as Value.
/// </summary>
using System;
...
namespace MusicManager
{
	...
	{
		private static Dictionary<string, string[]> dicSong = 
                                            new Dictionary<string, string[]> ();
		private static string className = "SongPaths";
		...
		public static bool ContainsKey (string keyItem)
		{
			...
			retVal = dicSong.ContainsKey (keyItem);
		...
		public static string[] ReturnItemValueAtKey (string keyItem)
		{
			...
			dicSong.TryGetValue (keyItem, out val);
