//
//  StoreConeCubicStandardCollection.cs
//
//  Author:
...
namespace BuildingFormulas
{
    ...
    /// <summary>
    /// Cubic area cone struct.
    /// </summary>
    public struct CubicAreaConeStruct
    {
        /// <summary>
        ...
        public void StoreCubicStandard(
            string solveType,
    ...
    /// <summary>
    /// Store cone cubic standard collection.
    /// </summary>
    public static class StoreConeCubicStandardCollection
    {
        /// <summary>
        /// The name of the class.
        /// </summary>
        private const string MyClassName = 
            "StoreConeCubicStandardCollection";
        ...
        /// The cubic list.
        /// </summary>
        private static List<CubicAreaConeStruct> dataList = new 
            List<CubicAreaConeStruct>();
        ...
        /// </summary>
        /// <returns>The <see 
        /// cref="BuildingFormulas.CubicAreaConeStruct"/>.</returns>
        /// <param name="index">The index.</param>
        public static CubicAreaConeStruct GetItemAt(int index)
        {
            CubicAreaConeStruct dataStruct = new CubicAreaConeStruct();

            const string MethodName = "public static " +
                                      "CubicAreaConeStruct GetItemAt(" +
                                      "int index)";
