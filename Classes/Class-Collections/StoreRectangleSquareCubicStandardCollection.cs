...
namespace BuildingFormulas
{
    ...
    /// </summary>
    public struct CubicAreaSquareRectangleStruct
    {
        /// <summary>
    ...
    /// </summary>
    public static class StoreRectangleSquareCubicStandardCollection
    {
        /// <summary>
        ...
        /// The cubic list.
        /// </summary>
        private static List<CubicAreaSquareRectangleStruct> dataList = new 
            List<CubicAreaSquareRectangleStruct>();
        ...
        public static bool AddNewItem(CubicAreaSquareRectangleStruct dataStruct)
        {
            bool retVal = false;
        ...
        public static CubicAreaSquareRectangleStruct GetItemAt(int index)
        {
            CubicAreaSquareRectangleStruct dataStruct = new 
