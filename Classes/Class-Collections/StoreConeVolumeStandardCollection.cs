...
namespace BuildingFormulas
{
	...
	/// </summary>
	public struct ConeVolumeStruct
	{
		/// <summary>
	...
	/// </summary>
	public static class StoreConeVolumeStandardCollection
	{
		/// <summary>
		...
		/// The cubic list.
		/// </summary>
		private static List<ConeVolumeStruct> dataList = new 
            List<ConeVolumeStruct>();
		...
		public static bool AddNewItem(ConeVolumeStruct dataStruct)
		{
			bool retVal = false;
		...
		public static ConeVolumeStruct GetItemAt(int index)
		{
			ConeVolumeStruct dataStruct = new ConeVolumeStruct();
