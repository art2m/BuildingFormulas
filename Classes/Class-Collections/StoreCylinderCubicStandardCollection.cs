...
namespace BuildingFormulas
{
    ...
    /// </summary>
    public struct CubicAreaCylinderStruct
    {
        /// <summary>
    ...
    /// </summary>
    public static class StoreCylinderCubicStandardCollection
    {
        /// <summary>
        ...
        /// The cubic list.
        /// </summary>
        private static List<CubicAreaCylinderStruct> dataList = new 
            List<CubicAreaCylinderStruct>();
        ...
        public static bool AddNewItem(CubicAreaCylinderStruct dataStruct)
        {
            bool retVal = false;
        ...
        public static CubicAreaCylinderStruct GetItemAt(int index)
        {
            CubicAreaCylinderStruct dataStruct = new 
                CubicAreaCylinderStruct();
